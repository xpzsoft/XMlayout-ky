		...
		var xmlayout = {
			...
			__load : function(panel, url, data, fun, title, style){
				...
				if(title != undefined && title != null){
					...
					if(div[0]){
						...
						if(style != undefined && style != null && style.pos == "center"){
							div.append($('<div style="height: 5px;"></div><center><span class="xmlayout_tt" style="font-size:15px; margin-left: 5px;">' + title + '</label></center>'));
						}
						else{
							div.append($('<div style="height: 5px;"></div><span class="xmlayout_tt" style="font-size:15px;margin-left: 5px;">' + title + '</label>'));
						}
				...
				if(url == null || url == undefined){
					console.error("XMlayout info: param 'url/obj' in function __load is null!");
					return;
				}
			...
			__addRightPanel : function(panel, rp, tb, indexp){
				...
				var div_html = '<div class="targ_panel" style="width:100%; height:100%; background-color: white; border-radius : 4px; overflow: auto;"></div>';
				if(!obj_this.isradius)
					div_html = '<div class="targ_panel" style="width:100%; height:100%; background-color: white; overflow: auto;"></div>';
				var upanel = $(div_html);
				if(tb){
			...
			design : function(rows, cols, rc, values, attr, node){
				...
				data.getData = function(index){
					var nd = obj_this.getDesignNode(index, this);
					if(nd != null)
